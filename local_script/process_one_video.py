...
class SingleVideoPipeline:
    ...
    def _validate_common_inputs(self) -> None:
        ...
        required_files = {
            ...
            "track_one_video.py": self.paths.project_root / "track_one_video.py",
            "recognize.py": self.paths.project_root / "recognize.py",
            "inference.py": self.paths.project_root / "inference.py",
            "visualization script": self.paths.project_root
            / "local_script"
            / "visualize_qwen_tracks.py",
        }
